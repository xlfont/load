...
pug_html = pug_html + "\u003Cp\u003E";
;pug_debug_line = 220;pug_debug_filename = "src\u002Fpug\u002Findex.pug";
pug_html = pug_html + "\u003Cp\u003Exfl.js 的確使用 \u003Ccode\u003E@font-family\u003C\u002Fcode\u003E 來設定字型子集的資訊，只是因為 \u003Ccode\u003E@font-family\u003C\u002Fcode\u003E 樣式是依字碼做動態生成，因此需要前端程式來做。而因為 \u003Ccode\u003E@xlfont\u002Fload\u003C\u002Fcode\u003E 的子集依字頻而非語言分組，若想完全依賴 \u003Ccode\u003Eunicode-range\u003C\u002Fcode\u003E 來描述各字碼對應之字型子集，需要表列相當大量的字碼。當然這仍然是一個可行的方式，我們可以考慮在未來版本支援無 JS 版的 xlfont 載入。\u003C\u002Fp\u003E\n\u003C\u002Fp\u003E";
...
;pug_debug_line = 230;pug_debug_filename = "src\u002Fpug\u002Findex.pug";
pug_html = pug_html + "\u003Ca href=\"https:\u002F\u002Fgithub.com\u002Fxlfont\u002Fcjk\"\u003E";
;pug_debug_line = 230;pug_debug_filename = "src\u002Fpug\u002Findex.pug";
