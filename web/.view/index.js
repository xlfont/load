...
pug_html = pug_html + "\u003Cdiv class=\"ldcv bare mt-2 position-fixed w-100\" id=\"gloader\"\u003E";
;pug_debug_line = 133;pug_debug_filename = "src\u002Fpug\u002Findex.pug";
...
pug_html = pug_html + "\n";
;pug_debug_line = 204;pug_debug_filename = "src\u002Fpug\u002Findex.pug";
pug_html = pug_html + "      font.sync(\"給定一些文字，@xlfont\u002Fload 就會幫你抓對應的字型檔\");";
...
pug_html = pug_html + "\u003Ch3\u003E";
;pug_debug_line = 210;pug_debug_filename = "src\u002Fpug\u002Findex.pug";
pug_html = pug_html + "與其它的網路字型服務比較？\u003C\u002Fh3\u003E";
...
pug_html = pug_html + "\u003Ch3\u003E";
;pug_debug_line = 219;pug_debug_filename = "src\u002Fpug\u002Findex.pug";
pug_html = pug_html + "何不使用 unicode-range 機制來做前端載入就好？\u003C\u002Fh3\u003E";
;pug_debug_line = 220;pug_debug_filename = "src\u002Fpug\u002Findex.pug";
pug_html = pug_html + "\u003Cp\u003E";
;pug_debug_line = 220;pug_debug_filename = "src\u002Fpug\u002Findex.pug";
pug_html = pug_html + "\u003Cp\u003E\u003Ccode\u003E@xlfont\u002Fload\u003C\u002Fcode\u003E 的確使用 \u003Ccode\u003E@font-family\u003C\u002Fcode\u003E 來設定字型子集的資訊，只是因為 \u003Ccode\u003E@font-family\u003C\u002Fcode\u003E 樣式是依字碼做動態生成，因此需要前端程式來做。而因為 \u003Ccode\u003E@xlfont\u002Fload\u003C\u002Fcode\u003E 的子集依字頻而非語言分組，若想完全依賴 \u003Ccode\u003Eunicode-range\u003C\u002Fcode\u003E 來描述各字碼對應之字型子集，需要表列相當大量的字碼。當然這仍然是一個可行的方式，我們可以考慮在未來版本支援無 JS 版的 xlfont 載入。\u003C\u002Fp\u003E\n\u003C\u002Fp\u003E";
;pug_debug_line = 221;pug_debug_filename = "src\u002Fpug\u002Findex.pug";
pug_html = pug_html + "\u003Cp\u003E";
;pug_debug_line = 221;pug_debug_filename = "src\u002Fpug\u002Findex.pug";
pug_html = pug_html + "\u003Cp\u003E此外，\u003Ccode\u003E@xlfont\u002Fload\u003C\u002Fcode\u003E 仍基於 \u003Ccode\u003Eopentype.js\u003C\u002Fcode\u003E 提供前端字型組合的機制，可用於根據子集繪制對應的向量檔。\u003C\u002Fp\u003E\n\u003C\u002Fp\u003E";
...
pug_mixins["script"]("assets/lib/@xlfont/load/dev/index.js");
